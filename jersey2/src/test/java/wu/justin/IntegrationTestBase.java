...
import wu.justin.rest2.NetworkUtil;
...
public class IntegrationTestBase {
	...
	public void before() throws Exception {
		...
		HttpClientBuilder builder = NetworkUtil.createTrustAllHttpClientBuilder();
	...
	public Object getJsonByRequest(HttpClient client, HttpGet request, Integer statusCodeExpected)
	...
	public Object getJsonByRequest(HttpClient client, HttpPost request, String body, Integer statusCodeExpected)
			throws HttpException, IOException {
	...
	public Object getJsonByRequest(HttpClient client, HttpPut request, String body, Integer statusCodeExpected)
			throws HttpException, IOException {
	...
	public Object getJsonByRequest(HttpClient client, HttpDelete request, Integer statusCodeExpected)
			throws HttpException, IOException {
