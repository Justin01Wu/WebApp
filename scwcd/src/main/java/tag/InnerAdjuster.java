 ...
 * InnerAdjuster.java
 *
 * Created on November 17, 2006, 8:21 PM
 */
...
public class InnerAdjuster extends BodyTagSupport {
    
	private static final long serialVersionUID = 4567681L;

	/** Creates new instance of tag handler */
    public InnerAdjuster() {
        super();
    }
    ...
    public int doStartTag() throws JspException, JspException {
        ...
        if(parent==null){
            throw new JspException("this must be nested other tags");
        }
        ...
        System.out.println("outerContent=" + outerContent);
        try {
            parentBobodyContent.clear();
            parentBobodyContent.append('9');
        } catch (IOException ex) {
