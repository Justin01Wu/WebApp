...
echo.
echo deleting folder C:\program2\apache-tomcat-7.0.55\webapps\jersey-rest
rmdir /S /Q C:\program2\apache-tomcat-7.0.55\webapps\jersey-rest
...
copy /Y target\jersey-rest.war C:\program2\apache-tomcat-7.0.55\webapps
